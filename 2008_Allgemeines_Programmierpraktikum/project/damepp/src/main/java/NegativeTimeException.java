...
/**
 * Fehlerklasse, die geworfen wird, wenn irgendwo eine
 * negative Zeit gespeichert werden soll.
 * @author Christian Otto
 */

public class NegativeTimeException extends TimeException
{
	...
	NegativeTimeException(String s)
	{
		super(s);
	}
}
